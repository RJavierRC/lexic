...
MODULE MOD_MainProgram
    ...
    ! Robot: r1
    ! Fecha: 28/07/2025 08:34:27
    ! Movimientos secuenciales: 15 pasos
    ! -------------------------------
    ...
    PROC Main()
        ...
        ! Program generated from Robot syntax on 28/07/2025 08:34:27
        ! Robot: r1
        ! Secuencia de 15 movimientos
        ...
        ! Paso 10: Mover codo de 0.0° a -45.0°
        MoveAbsJ [[90.0,30.0,-45.0,0.0,0.0,0.0],[9E+09,9E+09,9E+09,9E+09,9E+09,9E+09]],v150,z5,RobotiQ2F85Gripper(FullyClosed) \WObj:=Frame2;

        ! Paso 11: Esperar 2.0 segundos
        WaitTime 2.0;

        ! Paso 12: Mover base de 90.0° a 0.0°
        MoveAbsJ [[0.0,30.0,-45.0,0.0,0.0,0.0],[9E+09,9E+09,9E+09,9E+09,9E+09,9E+09]],v150,z5,RobotiQ2F85Gripper(FullyClosed) \WObj:=Frame2;

        ! Paso 13: Mover hombro de 30.0° a 0.0°
        MoveAbsJ [[0.0,0.0,-45.0,0.0,0.0,0.0],[9E+09,9E+09,9E+09,9E+09,9E+09,9E+09]],v150,z5,RobotiQ2F85Gripper(FullyClosed) \WObj:=Frame2;

        ! Paso 14: Mover codo de -45.0° a 0.0°

    ...
    def generate_com_file(self):
        ...
        try:
            ...
            if success and os.path.exists(original_path):
                ...
                success_msg = (
                    f"🤖 ¡TIMING EXACTO COMO ROBOT.EXE!\n\n"
                    f"📂 Archivo: {program_name}.com\n"
                    f"📏 Tamaño: {file_size} bytes\n"
                    f"📍 Ubicación: DOSBox2\\Tasm\\\n"
                    f"✅ Timing PRECISO: usa mismos valores de delay que ROBOT.EXE\n\n"
                    ...
                    f"⚡ TIMING PRECISO COMO ROBOT.EXE:\n"
                    f"• ✅ DELAY2/DELAY3: 0x0FFF ciclos (rápido)\n"
                    f"• ✅ DELAY4/DELAY5: 0xFFFF ciclos (lento)\n"
                    f"• ✅ Diferentes velocidades por motor\n"
                    f"• ✅ 3 motores funcionando correctamente\n"
                    f"• ✅ Patrones exactos: 0x0C, 0x06, 0x03, 0x09\n\n"
                    f"🎮 CARGAR EN PROTEUS:\n"
                    f"1. Archivo: {program_name}.com\n"
                    f"2. Procesador: 8086 Real Mode\n"
                    f"3. 8255 PPI en direcciones de robot.asm\n"
                    f"4. ¡Mismo timing que ROBOT.EXE!\n\n"
                    f"⚡ VELOCIDADES CONTROLADAS:\n"
                    f"• Velocidad 1-4 = DELAY5 (0xFFFF - lento)\n"
                    f"• Velocidad 5-6 = DELAY4 (0xFFFF - lento)\n"
                    f"• Velocidad 7-8 = DELAY3 (0x0FFF - rápido)\n"
                    f"• Velocidad 9+ = DELAY2 (0x0FFF - rápido)\n\n"
                    f"🔥 DIFERENCIAS VISIBLES: ¡Ahora puedes ver las velocidades!"
                )

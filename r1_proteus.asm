...
;===============================================
; PROCEDIMIENTO MOTOR BASE - 45 GRADOS
;===============================================
MOVE_BASE_45 PROC
    PUSH CX
    PUSH AX
...
;===============================================
; PROCEDIMIENTO MOTOR HOMBRO - 120 GRADOS
;===============================================
MOVE_HOMBRO_120 PROC
    PUSH CX
    PUSH AX
    
    ; Ejecutar 66 pasos para 120 grados
    MOV CX, 66            ; Nmero de pasos
STEP_LOOP_HOMBRO_120:
    MOV AL, 01h         ; Patrn de paso 1
    OUT DX, AL
    CALL SHORT_DELAY
    MOV AL, 03h         ; Patrn de paso 2
    ...
    OUT DX, AL
    CALL SHORT_DELAY
    LOOP STEP_LOOP_HOMBRO_120
    
    POP AX
    POP CX
    RET
MOVE_HOMBRO_120 ENDP

;===============================================
; PROCEDIMIENTO MOTOR CODO - 90 GRADOS
;===============================================
MOVE_CODO_90 PROC
    PUSH CX
    PUSH AX
